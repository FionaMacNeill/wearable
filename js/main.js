...
/*!---------------------------------------------------------------------------------------------------------------------
 * CUSTOM Script by F. MacNeill using smooth-scroll functions for the return to top button
 * and a custom event listener for the button's appearance
 ---------------------------------------------------------------------------------------------------------------------*/
    ...
    window.addEventListener('scroll', function() {
        if (window.scrollY >= 500){
            topBtn.classList.add("return-top-button-active");
        } else if (window.scrollY <= 500) {
            topBtn.classList.remove("return-top-button-active");
        }
    }, false);
