/*
 JavaScript for Website for perioperative wearable device - an interactive site explaining a project

 Copyright (C) 2016  Fiona MacNeill
 ...
 Copyright (c) 2016 Metafizzy
 Modified by F. MacNeill, December 2016.

 --------------AND---------------

 contact.js section
 Copyright 2016 Marcus Winter. Used with permission.
 * Includes PHPMailer by Andy Prevost and Marcus Bointon
 * * Distributed under the Lesser General Public License (LGPL): http://www.gnu.org/copyleft/lesser.html
 * * Copyright (c) 2004-2009, Andy Prevost. All Rights Reserved. Copyright (c) 2001-2003, Brent R. Matzelle
 Modified by F. MacNeill, January 2017.
...
* Button listener for "menu" navigation unfolding at <= 470px window.width
* loosely based on https://codepen.io/anon/pen/pNmOmY?editors=1100 and
* http://codepen.io/razitazi/pen/WbZaOq - worked with the CSS values
----------------------------------------------------------------------------------------------------------------------*/


    var toggle = document.querySelector(".toggle");
    var hdHeight = document.querySelector(".site-header");
    /* This variable is used to control the height of the timeline and its position relative to the site-header */
    var ln = document.querySelector(".timeline-line-end");


    // Listen for click event on the menu toggle button
    toggle.addEventListener('click', function() {
        ...
        ln.classList.toggle("menuActive");
    }, false );
...
/*!---------------------------------------------------------------------------------------------------------------------
 * END OF smooth-scroll v10.2.1 *(c) 2016 Chris Ferdinandi ** MIT License ** http://github.com/cferdinandi/smooth-scroll
 ---------------------------------------------------------------------------------------------------------------------*/

/*!---------------------------------------------------------------------------------------------------------------------
 * CUSTOM Script by F. MacNeill using smooth-scroll functions
 ---------------------------------------------------------------------------------------------------------------------*/

/* Script to control the return to the top button */
 ...
 *
 * Modified by F. MacNeill, November 2016.
 ---------------------------------------------------------------------------------------------------------------------*/

/*-----JQuery specific widget content removed from this section----*/
...
// -------------------------- PageDots -------------------------- //
    ...
    PageDots.prototype._create = function() {
        ...
        /* flickity page dots had to be renamed for reader mode */
        this.holder.className = 'hidden';
...
/*!---------------------------------------------------------------------------------------------------------------------
* END OF Flickity PACKAGED v2.0.5 ** Licensed GPLv3 for open source use ** http://flickity.metafizzy.co
* * Copyright 2016 Metafizzy
* Modified by F. MacNeill, November 2016.
---------------------------------------------------------------------------------------------------------------------*/

/*!---------------------------------------------------------------------------------------------------------------------
 * Contact.js based on code by Marcus Winter. (c) 2016 Marcus Winter. Used with permission.
 * Includes PHPMailer by Andy Prevost and Marcus Bointon
 * * Distributed under the Lesser General Public License (LGPL): http://www.gnu.org/copyleft/lesser.html
 * * Copyright (c) 2004-2009, Andy Prevost. All Rights Reserved. Copyright (c) 2001-2003, Brent R. Matzelle
 * Modified by F. MacNeill, January 2017.
...
function sendmail() {
    ...
    if(fields_ok) {
        ...
        request.open("POST", "contactform/sendmail.php", true);
